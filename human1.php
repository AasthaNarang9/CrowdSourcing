...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/hr11.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/hr12.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/hr13.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Home4Kids Healing Architecture</h1><br><br><br>
            <h4>Designing a children's village in the Philippines with the help of Intuitive-Holistic-Architecture.</h4>
            <br><br>
            <p class="price"> Rs50,571</p>
    ...
    <hr width="2px">
   <center>
       <img src="./img/hr14.PNG"><br>
         <img src="./img/hr15.png"><br>
        
         <img src="./img/hr16.jpg"><br>
         <img src="./img/hr17.png"><br>
    
       <img src="./img/hr18.png"><br>
 
       <img src="./img/hr19.jpg"><br>
