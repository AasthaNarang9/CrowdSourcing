...
<body>
  <div>
    ...
    <div>
      <div class="slideshow-container " style="z-index: -1000;">
        <div class="mySlides w3-animate-right">
          ...
          <img src="./img/v1.jpg" style="width:100%">
        </div>
        <div class="mySlides w3-animate-right">
          <div class="numbertext">2 / 3</div>
          <img src="./img/v2.jpg" style="width:100%">
        </div>
        <div class="mySlides w3-animate-right">
          <div class="numbertext">3 / 3</div>
          <img src="./img/v3.jpg" style="width:100%">
          <div class="text">
    ...
    <div style="display: flex; justify-content: space-around;">
      ...
      <div style="display: flex; justify-content: space-around; border-radius: 10px; padding-bottom: 30px; ">
          <div class="card" style="width: 30%;padding-bottom: 30px;" >
            <img src=".\img\env1.jpg" style="width:100%">
            <h1>Buy a Brick for The Nikola Tesla Museum</h1>
            <p class="price">Rs. 10,811,484</p>
            <p>Make your mark on the Nikola Tesla Museum.</p><br><br>
            <form action="envirp.html">
              <button type="submit">VIEW DETAILS</button>
            </form>
          </div>

         <div class="card" style="width: 30%; padding-bottom: 30px;">
            <img src=".\img\e01.jpeg"style="width:100% ">
            <h1>Shanikya Pollution Controller</h1>
            <p class="price">Rs. 2,811,484</p>
            <p>Wireless Charging Case, Db limit count, Unique Star-Ring Design, IPX5, Bluetooth 5.0</p><br>
            <form action="environment2.html">
                <button type="submit">VIEW DETAILS</button>
            </form>
        </div>

        <div class="card" style="width: 30%; padding-bottom: 30px;" >
            <img src=".\img\en1.jpeg" style="width:100%">
            <h1>Elephant Refuge</h1>
            <p class="price">Rs. 42,011,484</p>
            <p>A place for elephants from other countries on outskirts of Haryana</p><br><br><br><br>
            <form action="environment3.html">
              <button type="submit">VIEW DETAILS</button>
            </form>
        </div>
    </div>
    ...
    <div style="display: flex; justify-content: space-around; border-radius: 10px;">
        <div class="card" style="width: 30%; padding-bottom: 30px;" >
          <img src=".\img\ep4.jpg"style="width:100%">
          <h1>Reusable Paper Bags</h1>
          <p class="price">Rs. 34,841,484</p>
          <p>Made with smooth paper, introducing ICTC technology that helps in reusing</p>
         <form action="environment4.html">
            <button type="submit">VIEW DETAILS</button>
          </form>
        </div>

           <div class="card" style="width: 29%; padding-bottom: 30px;" >
  <img src=".\img\b2.jpeg"style="width:100%">
  <h1>CoronaVirus Identifier</h1>
  <p class="price">Rs. 4,841,484</p>
  <p>Hybrid ANC | Transparency Mode | Superb Quality | Identification | Quick Analysis</p>
 <form action="environment5.html">
 <button type="submit">VIEW DETAILS</button>
    </form>
</div>

           <div class="card" style="width: 30%; padding-bottom: 30px;" >
  <img src=".\img\v4.jpg"style="width:100%">
  <h1>Desert Bloom Farm </h1>
  <p class="price">Rs. 4,841,484</p>
  <p>Built in midst of Sahara desert, supports the production of dates and raisins</p><br>
 <form action="environment6.html">
 <button type="submit">VIEW DETAILS</button>
    </form>
</div>
</div>
