...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/d23.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/d24.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/d25.png" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Battlefield Addiction - We Got You!</h1><br><br><br>
            <h4>Support Battlefield Addiction as we tackle the 10-mile Tough Mudder Course in Seattle, WA</h4>
            <br><br>
    ...
    <hr width="2px">
   <center>
       <img src="./img/d26.PNG"><br>
         <img src="./img/d27.PNG"><br>
        
         <img src="./img/d28.PNG"><br>
         <img src="./img/d29.png"><br>
    
       <img src="./img/d30.jpg"><br>
       <img src="./img/d31.png"><br>
 <img src="./img/d32.png"><br>
       <img src="./img/d33.png"><br>
       <img src="./img/d34.png"><br>
       <img src="./img/d35.png"><br>
       <img src="./img/d36.png"><br>
