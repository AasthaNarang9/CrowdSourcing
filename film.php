...
<body>
  <div>
    ...
    <div style="display: flex; justify-content: space-around;">
      ...
      <div style="display: flex; justify-content: space-around; border-radius: 10px; padding-bottom: 30px; ">
         ...
         <div class="card" style="width: 30%; padding-bottom: 30px;">
            <img src=".\img\f111.jpg"style="width:100% ">
            <h2>The Family Crow: A Murder Mystery </h2>
            <p class="price">Rs. 5,00,000</p>
            <p> Adam and The Pucking Fuppet Co. are hitting the road again this year with a brand new one-man-crow.</p><br><br><br><br><br>
            <form action="pr1.html">
                <button type="submit"><a href="filmp1.html">VIEW DETAILS</a></button>
            </form>
        </div>
            <div class="card" style="width: 30%;padding-bottom: 30px;" >
            <img src=".\img\f211.jpg" style="width:100%">
            <h2>Dohee Lee Puri Arts Matching Fund Campaign</h2>
            <p class="price">Rs. 120,290</p>
            <p>Help us match our grant from the East Bay Community Foundation and premiere MU/巫: 9 Goddesses!</p><br><br>
            <form action="p2.html">
            <button type="submit"><a href="filmp2.html">VIEW DETAILS</a></button>
            </form>
          </div>


        <div class="card" style="width: 30%; padding-bottom: 30px;" >
            <img src=".\img\f311.jpg" style="width:100%">
            <h2>Match our Jerome Robbins General Operations Grant!</h2>
            <p class="price">Rs. 1,209,259</p>
            <p>We have received a general operational award from Jerome Robbins Foundation and we want to match it!</p><br><br>
            <form action="p3.html">
             <button type="submit"><a href="filmp3.html">VIEW DETAILS</a></button>
            </form>
        </div>
    </div>
    ...
    <div style="display: flex; justify-content: space-around; border-radius: 10px;">
        <div class="card" style="width: 30%; padding-bottom: 30px;" >
          <img src=".\img\f411.jpg"style="width:100%">
          <h2>The Uphill Theatre Company: </h2>
          <p class="price">Rs. 34,841,484</p>
          <p>The Uphill Theatre Company is going to the 2020 Hollywood Fringe Festival and we need your help!</p><br><br><br>
         <form action="p4.html">
           <button type="submit"><a href="filmp4.html">VIEW DETAILS</a></button>
          </form>
        </div>

           <div class="card" style="width: 29%; padding-bottom: 30px;" >
  <img src=".\img\f511.jpg"style="width:100%">
  <h2>'No Solicitors' at New Voices 2020</h2>
  <p class="price">4,841,484</p>
  <p>We're producing a theatrical production of a new Canadian play for RSP's New Voices Festival!</p><br><br><br>
 <form action="p5.html">
 <button type="submit"><a href="filmp5.html">VIEW DETAILS</a></button>
    </form>
</div>

           <div class="card" style="width: 30%; padding-bottom: 30px;" >
  <img src=".\img\f611.jpg"style="width:100%">
  <h2>Juniper and Jules </h2>
  <p class="price">Rs. 4,841,484</p>
  <p>Award winning queer female love story transfers to the Soho Theatre this April - May 2020</p><br><br><br><br>
 <form action="p6.html">
<button type="submit"><a href="filmp6.html">VIEW DETAILS</a></button>
    </form>
</div>
</div>
