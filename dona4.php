...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/d52.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/d53.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/d54.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Alive To Thrive Foundation</h1><br><br><br>
            <h4>Support our mission to create an army of compassionate and influential leaders to serve the world!</h4>
            <br><br>
    ...
    <hr width="2px">
   <center>
       <img src="./img/d55.PNG"><br>
         <img src="./img/d56.PNG"><br>
        
         <img src="./img/d57.PNG"><br>
         <img src="./img/d58.png"><br>
    
       <img src="./img/d59.jpg"><br>
       <img src="./img/d60.png"><br>
 <img src="./img/d61.png"><br>
       <img src="./img/d62.png"><br>
       <img src="./img/d63.png"><br>
       <img src="./img/d64.png"><br>
