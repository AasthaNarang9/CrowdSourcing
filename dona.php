    ...
    <div>
      <div class="slideshow-container " style="z-index: -1000;">
        ...
        <div class="mySlides w3-animate-right">
          ...
          <img src="./img/d2.jpg" style="width: 100%">
        </div>
        <div class="mySlides w3-animate-right">
          <div class="numbertext">3 / 3</div>
          <img src="./img/d4.jpg" style="width:100%">
          <div class="text">
   ...
   <div style="display: flex; justify-content: space-around;">
      ...
      <div style="display: flex; justify-content: space-around; border-radius: 10px; padding-bottom: 30px; ">
          <div class="card" style="width: 30%;padding-bottom: 30px;" >
            <img src=".\img\d5.jpg" style="width:100%">
            <h1> Fresh Yoga Refresh </h1>
            <p class="price">Rs.7,61,241</p>
            <p>Help Fresh Yoga become accessible to all - Support our transformation to a donations-based system.</p><br>
            <form action="dona1.php">
              <button type="submit">VIEW DETAILS</button>
            </form>
          </div>

         <div class="card" style="width: 30%; padding-bottom: 30px;">
            <img src=".\img\d9.png"style="width:100% ">
            <h1>Battlefield Addiction - We Got You!</h1>
            <p class="price">Rs.1,295</p>
            <p>Support Battlefield Addiction as we tackle the 10-mile Tough Mudder Course in Seattle, WA
</p><br>
            <form action="dona2.php">
                <button type="submit">VIEW DETAILS</button>
            </form>
        </div>

        <div class="card" style="width: 30%; padding-bottom: 30px;" >
            <img src=".\img\d10.jpg" style="width:100%">
            <h1>Lotus Flower Lounge!</h1>
            <p class="price">Rs.24,99,531</p>
            <p>Join LOTUSWEI in creating a new wellness hub + flower elixir apothecary.</p><br><br>
            <form action="dona3.php">
              <button type="submit">VIEW DETAILS</button>
            </form>
        </div>
    </div>
    ...
    <div style="display: flex; justify-content: space-around; border-radius: 10px;">
        <div class="card" style="width: 30%; padding-bottom: 30px;" >
          <img src=".\img\d11.jpg"style="width:100%">
          <h1>Alive To Thrive Foundation</h1>
          <p class="price">Rs.5,19,235</p>
          <p>Support our mission to create an army of compassionate and influential leaders to serve the world!.</p><br><br>
         <form action="dona4.php">
            <button type="submit">VIEW DETAILS</button>
          </form>
        </div>

           <div class="card" style="width: 29%; padding-bottom: 30px;" >
  <img src=".\img\d12.jpg"style="width:100%">
  <h1>Legalize Medical Marijuana</h1>
  <p class="price">Rs.6,42,367</p>
  <p>Texans deserve safe and legal access to medical marijuana. Let's make it a reality -- Donate Today!</p><br>
 <form action="dona5.php">
 <button type="submit">VIEW DETAILS</button>
    </form>
</div>

           <div class="card" style="width: 30%; padding-bottom: 30px;" >
  <img src=".\img\d13.jpg"style="width:100%">
  <h1>Joy Is My Armor Ashtanga Yoga</h1>
  <p class="price">Rs.49,368 </p>
  <p>Raise Money For the Wild Bird Fund & Support Ashtanga Yoga!</p><br><br><br>
 <form action="dona6.php">
 <button type="submit">VIEW DETAILS</button>
    </form>
</div>
</div>
