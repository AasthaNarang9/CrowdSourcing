...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              <img src="./img/lb5.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/lb6.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>La Petite Creme is moving out of Mommy's kitchen!</h1><br><br><br>
            <h4>Your favorite French Mompreneurs need your help to furnish their new dedicated factory.</h4>
            <br><br>
            <p class="price"> Rs 2,18,660</p>
    ...
    <hr width="2px">
   <center>
       <img src="./img/lb12.PNG"><br>
         <img src="./img/lb13.PNG"><br>
        
         <img src="./img/lb14.PNG"><br>
         <img src="./img/lb15.PNG"><br>
    
       <img src="./img/lb16.PNG"><br>
       
       <img src="./img/lb17.PNG"><br>
