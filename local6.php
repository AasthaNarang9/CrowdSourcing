...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/lb66.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/lb65.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/lb64.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Boulder Parc Climbing Gym in Scarborough</h1><br><br><br>
            <h4>Launching a world-class climbing gym in Scarborough offering climbing, training, cafe, & workspace.</h4>
            <br><br>
            <p class="price"> Rs 22,92,851 </p>
   ...
   <center>
         ...
         <img src="./img/lb67.PNG"><br>
         <img src="./img/lb68.PNG"><br>
    
       <img src="./img/lb69.PNG"><br>
       
       <img src="./img/lb70.PNG"><br>
  <img src="./img/lb71.PNG"><br>
    <img src="./img/lb72.PNG"><br>
        <img src="./img/lb73.PNG"><br>
        <img src="./img/lb74.PNG"><br>
        <img src="./img/lb75.PNG"><br>
