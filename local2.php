...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/lb20.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/lb19.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/lb18.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Butter Cake Shoppe Needs Your Help to Grow!</h1><br><br><br>
            <h4>Your contribution will help us finish the construction of our full-service family bakery.</h4>
            <br><br>
    ...
    <hr width="2px">
   <center>
       <img src="./img/lb21.PNG"><br>
         <img src="./img/lb22.jpg"><br>
        
         <img src="./img/lb23.PNG"><br>
         <img src="./img/lb24.PNG"><br>
    
       <img src="./img/lb25.PNG"><br>
       
       <img src="./img/lb26.PNG"><br>
  <img src="./img/lb27.PNG"><br>
        <img src="./img/lb28.PNG"><br>
        <img src="./img/lb29.PNG"><br>
        <img src="./img/lb30.PNG"><br>
