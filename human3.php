...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/hr28.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/hr29.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/hr30.png" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Animation for Tibet</h1><br><br><br>
            <h4>A beautiful animated short film to capture the struggle of the Tibetan people and tell their story.</h4>
            <br><br>
            <p class="price"> Rs 1,357,964</p>
    ...
    <hr width="2px">
   <center>
       <img src="./img/hr31.PNG"><br>
         <img src="./img/hr32.png"><br>
        
         <img src="./img/hr33.jpg"><br>
         <img src="./img/hr34.png"><br>
    
       <img src="./img/hr35.png"><br>
