...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/cul48.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/cul49.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/cul50.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Join the #REDvolution at LSUC 2019 in India</h1><br><br><br>
            <h4>Weave the change you want to see in the world, to unlearn stereotypes about female body</h4>
            <br><br>
            <p class="price"> Rs 50,705</p>
    ...
    <hr width="2px">
   <center>
       <img src="./img/cul51.png"><br>
         <img src="./img/cul52.PNG"><br>
        
         <img src="./img/cul53.PNG"><br>
         <img src="./img/cul54.PNG"><br>
         <img src="./img/cul55.jpg"><br>
    
       <img src="./img/cul56.png"><br>
 <img src="./img/cul57.png"><br>
       <img src="./img/cul58.png"><br>
       <img src="./img/cul59.png"><br> 
   <img src="./img/cul60.png"><br>
       <img src="./img/cul61.png"><br>
       <img src="./img/cul62.jpg"><br>
  </center><br><br>
