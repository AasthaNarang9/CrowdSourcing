...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              <img src="./img/d7.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/d8.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Help Fresh Yoga Refresh as Donations-Based!</h1><br><br><br>
            <h4>Help Fresh Yoga become accessible to all - Support our transformation to a donations-based system.</h4>
            <br><br>
    ...
    <hr width="2px">
   <center>
       <img src="./img/d14.PNG"><br>
         <img src="./img/d15.jpg"><br>
        
         <img src="./img/d16.PNG"><br>
         <img src="./img/d17.png"><br>
    
       <img src="./img/d18.jpg"><br>
       <img src="./img/d19.png"><br>
 <img src="./img/d20.png"><br>
       <img src="./img/d21.png"><br>
       <img src="./img/d22.png"><br>
