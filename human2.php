...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/hr20.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/hr21.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/hr22.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>The Pink Box Project</h1><br><br><br>
            <h4>A community project to help rescue sex trafficking and abuse victims.</h4>
            <br><br>
    ...
    <hr width="2px">
   <center>
       <img src="./img/hr23.PNG"><br>
         <img src="./img/hr24.png"><br>
        
         <img src="./img/hr25.png"><br>
         <img src="./img/hr26.png"><br>
    
       <img src="./img/hr27.jpg"><br>
 </center><br><br>
