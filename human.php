...
<body>
  <div>
    ...
    <div>
      <div class="slideshow-container " style="z-index: -1000;">
        <div class="mySlides w3-animate-right">
          ...
          <img src="./img/hr1.png" style="width: 100%">
        </div>
        <div class="mySlides w3-animate-right">
          <div class="numbertext">2 / 3</div>
          <img src="./img/hr3.jpg" style="width: 100%">
        </div>
        <div class="mySlides w3-animate-right">
          <div class="numbertext">3 / 3</div>
          <img src="./img/hr4.jpg" style="width:100%">
          <div class="text">
    ...
    <div style="display: flex; justify-content: space-around;">
      ...
      <div style="display: flex; justify-content: space-around; border-radius: 10px; padding-bottom: 30px; ">
          <div class="card" style="width: 30%;padding-bottom: 30px;" >
            <img src=".\img\hr5.jpg" style="width:100%">
            <h1>Home4Kids Healing Architecture</h1>
            <p class="price">Rs. 50,571 </p>
            <p>Designing a children’s village in the Philippines with the help of Intuitive-Holistic-Architecture.</p>
            <form action="human1.php">
              <button type="submit">VIEW DETAILS</button>
            </form>
          </div>

         <div class="card" style="width: 30%; padding-bottom: 30px;">
            <img src=".\img\hr6.jpg"style="width:100% ">
            <h1>The Pink Box Project</h1>
            <p class="price">Rs.4,475</p>
            <p>A community project to help rescue sex trafficking and abuse victims.</p><br><br><br>
            <form action="human2.php">
                <button type="submit">VIEW DETAILS</button>
            </form>
        </div>

        <div class="card" style="width: 30%; padding-bottom: 30px;" >
            <img src=".\img\hr7.png" style="width:100%">
            <h1>Animation for Tibet</h1>
            <p class="price">Rs.77,15,453</p>
            <p>A beautiful animated short film to capture the struggle of the Tibetan people and tell their story</p><br><br>
            <form action="human3.php">
              <button type="submit">VIEW DETAILS</button>
            </form>
        </div>
    </div>
    ...
    <div style="display: flex; justify-content: space-around; border-radius: 10px;">
        <div class="card" style="width: 30%; padding-bottom: 30px;" >
          <img src=".\img\hr8.jpg"style="width:100%">
          <h1>Support Kindness Cafe </h1>
          <p class="price">Rs.1,945,796</p>
          <p>Kindness Cafe employs adults with cognitive disabilities. It'll be the most welcoming cafe in town!</p><br><br>
         <form action="human4.php">
            <button type="submit">VIEW DETAILS</button>
          </form>
        </div>

           <div class="card" style="width: 29%; padding-bottom: 30px;" >
  <img src=".\img\hr9.jpg"style="width:100%">
  <h1>Rejuvenation Station</h1>
  <p class="price">Rs.3,687,117</p>
  <p>A mobile shower & laundry facility for people in need.</p><br><br><br><br>
 <form action="human5.php">
 <button type="submit">VIEW DETAILS</button>
    </form>
</div>

           <div class="card" style="width: 30%; padding-bottom: 30px;" >
  <img src=".\img\hr10.jpg"style="width:100%">
  <h1>Feed hungry children in Yemen</h1>
  <p class="price">Rs.5,157,994</p>
  <p>Around 2.9 million women and children are acutely malnourished in Yemen.</p><br><br>
 <form action="human6.php">
 <button type="submit">VIEW DETAILS</button>
    </form>
</div>
</div>
