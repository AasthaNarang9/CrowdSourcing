...
<body>
  <div>
    ...
    <div>
     <div class="slideshow-container " style="z-index: -1000;">
        <div class="mySlides w3-animate-right">
          ...
          <img src=".\img\comics1.jpg" style="width:100%">
        </div>
        <div class="mySlides w3-animate-right">
          <div class="numbertext">2 / 3</div>
          <img src=".\img\comics2.jpg" style="width:100%">
        </div>
        <div class="mySlides w3-animate-right">
          <div class="numbertext">3 / 3</div>
          <img src=".\img\comics3.jpg" style="width:100%">
    ...
    <div style="display: flex; justify-content: space-around;">
      ...
      <div style="display: flex; justify-content: space-around; border-radius: 10px; padding-bottom: 30px; ">
         ...
         <div class="card" style="width: 30%; padding-bottom: 30px;">
            <img src=".\img\cb111.jpg"style="width:100% ">
            <h2>Blade Devil: </h2>
            <p class="price">Rs. 5,00,000</p>
            <p> A warrior sacrifices her humanity to save her sister's soul</p><br><br><br><br><br>
            <form action="pr1.html">
                <button type="submit"><a href="comicsp1.html">VIEW DETAILS</a></button>
            </form>
        </div>
            <div class="card" style="width: 30%;padding-bottom: 30px;" >
            <img src=".\img\c211.jpg" style="width:100%">
            <h2>STILL MISSING</h2>
            <p class="price">Rs. 120,290</p>
            <p>STILL MISSING is a beautifully designed art book exploring the folk art of lost & found pet posters.</p><br><br><br><br>
            <form action="p2.html">
            <button type="submit"><a href="comicsp2.html">VIEW DETAILS</a></button>
            </form>
          </div>


        <div class="card" style="width: 30%; padding-bottom: 30px;" >
            <img src=".\img\c311.jpg" style="width:100%">
            <h2> Expendables Novel</h2>
            <p class="price">Rs. 1,209,259</p>
            <p>The Expendables are BACK! Story by SYLVESTER STALLONE & CHUCK DIXON. </p><br><br><br>
            <form action="p3.html">
             <button type="submit"><a href="comicsp3.html">VIEW DETAILS</a></button>
            </form>
        </div>
    </div>
    ...
    <div style="display: flex; justify-content: space-around; border-radius: 10px;">
        <div class="card" style="width: 30%; padding-bottom: 30px;" >
          <img src=".\img\cb411.jpg"style="width:100%">
          <h2>BIGFOOT BILL 2: Finger of Poseidon</h2>
          <p class="price">Rs. 34,841,484</p>
          <p>From the creator of EARTHWORM JIM comes the 2nd chapter of the hard-bound BIGFOOT BILL epic!</p><br><br><br>
         <form action="p4.html">
           <button type="submit"><a href="comicsp4.html">VIEW DETAILS</a></button>
          </form>
        </div>

           <div class="card" style="width: 29%; padding-bottom: 30px;" >
  <img src=".\img\cb511.jpg"style="width:100%">
  <h2>GOLMA Graphic Novel</h2>
  <p class="price">4,841,484</p>
  <p>Action adventure graphic novel exploring the once thriving world of Golma and Aerah the Immortal.</p><br><br><br>
 <form action="p5.html">
 <button type="submit"><a href="comicsp5.html">VIEW DETAILS</a></button>
    </form>
</div>

           <div class="card" style="width: 30%; padding-bottom: 30px;" >
  <img src=".\img\cb611.png"style="width:100%">
  <h2>Tara Normal: The Complete Webcomic Series</h2>
  <p class="price">Rs. 4,841,484</p>
  <p>An exclusive edition book collecting the complete Tara Normal webcomic.</p><br><br>
 <form action="p6.html">
<button type="submit"><a href="comicsp6.html">VIEW DETAILS</a></button>
    </form>
</div>
</div>
