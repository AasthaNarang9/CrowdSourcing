...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/d75.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/d76.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/d77.jpg"class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Joy Is My Armor Ashtanga Yoga!</h1><br><br><br>
            <h4>Raise Money For the Wild Bird Fund & Support Ashtanga Yoga!</h4>
            <br><br>
    ...
    <hr width="2px">
   <center>
       <img src="./img/d78.PNG"><br>
     
         <img src="./img/d79.jpg"><br>
         <img src="./img/d80.PNG"><br>
    
       <img src="./img/d81.PNG"><br>
       <img src="./img/d82.png"><br>

     
       <img src="./img/d83.png"><br>
