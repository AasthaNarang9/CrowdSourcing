...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/hr45.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/hr46.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/hr47.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Rejuvenation Station</h1><br><br><br>
            <h4>A mobile shower & laundry facility for people in need.</h4>
            <br><br>
            <p class="price"> Rs 36,87,117</p>
    ...
    <hr width="2px">
   <center>
       <img src="./img/hr48.PNG"><br>
         <img src="./img/hr49.png"><br>
        
         <img src="./img/hr50.png"><br>
         <img src="./img/hr51.png"><br>
    
       <img src="./img/hr52.png"><br>
 
       <img src="./img/hr53.png"><br>
    <img src="./img/hr54.png"><br>
