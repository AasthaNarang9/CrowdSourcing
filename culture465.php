...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/cul39.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/cul38.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/cul40.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>XX3 Jazz Fest Sarajevo 2019</h1><br><br><br>
            <h4>After 22 years, we need your help to co-fund the XX3rd international music festival in Sarajevo.</h4>
            <br><br>
            <p class="price"> Rs 1,330,506 </p>
    ...
    <hr width="2px">
   <center>
       <img src="./img/cul41.PNG"><br>
         <img src="./img/cul42.PNG"><br>
         <img src="./img/cul43.PNG"><br>
         <img src="./img/cul44.PNG"><br>
         <img src="./img/cul45.PNG"><br>
         <img src="./img/cul46.PNG"><br>
    
 <img src="./img/cul47.jpg"><br><br>
