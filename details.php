...
<body>
	<div>
		<div>
			<ul style="height: 68px; margin: 0; display: flex;justify-content: space-between;">
				<li class="headerlist" style="position: static; float: left; margin-top: 5px;"><a
					...
					<li class="headerlist" style="position: static; float: right; margin-top: 5px; padding: 12px;"><?php echo 'Hi '. $_SESSION['name'];?></li>
			...
			<center>
				...
				<div class="container-contact100">
					<div class="wrap-contact100">
						<form class="contact100-form validate-form" action="basic.php" method="post" enctype="multipart/form-data">
							...
							<div class="wrap-input100 validate-input bg1" data-validate="Please Type Your Name">
								...
								if(isset($_GET['N']))
								{
									$name=$_GET['N'];
									echo "
									<input class='input100' type='text' name='name' placeholder='Enter Your Project Name' value=".$name.">";
								}
								else{
									echo "
							...
							<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" >
								...
								if(isset($_GET['P']))
								{
									$P=$_GET['P'];
									echo "
									<input class='input100' type='text' name='tag' placeholder='Product Tagline' value=".$P.">";
								}
								else{
									echo "
							...
							<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate = "Enter Your Email (e@a.x)">
								...
								if(isset($_GET['D']))
								{
									$D=$_GET['D'];
									echo "
									<input class='input100' type='text' name='duration' placeholder='Duration of Your Project ' value=".$D.">";
								}
								else{
									echo "
							...
							<div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate = "Please Type Your Message">
								...
								if(isset($_GET['T']))
								{
									$T=$_GET['T'];
									echo "
									<textarea class='input100' name='message' placeholder='Your description here...' >".$T."</textarea >";
								}
								else{
									echo "
							...
							<div class="wrap-input100 validate-input bg0 rs1-alert-validate">
								...
								<h4>Select image to upload:</h4><br><br>
								<input type="file" name="fileToUpload0" id="fileToUpload"><br>
								<?php
								if(isset($_GET['E=0'])&& $_GET['E']==0) 
								{
									if($_GET['error']==='0too_large')
										echo "Image file too large"; 
									else if($_GET['error']==='0not_image')
										echo "Not An Image file";
									else if($_GET['error']==='0formate_not_valid')
										echo "Image formate not supported";
									else if($_GET['error']==='0not_uploaded')
										echo "Error uploading image please choose another file";
									echo "<br>";
								}
								...
								{
									if($_GET['error']==='1too_large')
										echo "Image file too large"; 
									else if($_GET['error']==='1not_image')
										echo "Not An Image file";
									else if($_GET['error']==='1formate_not_valid')
										echo "Image formate not supported";
									else if($_GET['error']=='1not_uploaded')
										echo "Error uploading image please choose another file";
									echo "<br>";
								}
								...
								{ 
									if( $_GET['error']==='2too_large')
										echo "Image file too large"; 
									else if($_GET['error']==='2not_image')
										echo "Not An Image file";
									else if($_GET['error']==='2formate_not_valid')
										echo "Image formate not supported";
									else if($_GET['error']==='2not_uploaded')
										echo "Error uploading image please choose another file";
									echo "<br>";
								}
								...
								<span><input type="Submit" name="submit" value="Submit" style="text-decoration: none; color: white; font-size: 20px; background-color: transparent;">
								</span>
								</button>
								</div>
								</form>
