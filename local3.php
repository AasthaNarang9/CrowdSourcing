...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/lb31.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/lb32.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/lb33.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Mindful Market: a heart-centered marketplace</h1><br><br><br>
            <h4>The #1 platform where you can shop your values, build a conscious business and elevate humanity..</h4>
            <br><br>
    ...
    <hr width="2px">
   <center>
       <img src="./img/lb34.PNG"><br>
         <img src="./img/lb35.PNG"><br>
        
         <img src="./img/lb36.PNG"><br>
         <img src="./img/lb37.PNG"><br>
    
       <img src="./img/lb38.PNG"><br>
       
       <img src="./img/lb39.PNG"><br>
  <img src="./img/lb40.PNG"><br>
        <img src="./img/lb41.PNG"><br>
        <img src="./img/lb42.PNG"><br>
