...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/cul28.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/cul29.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/cul30.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Save College of Wizardry!</h1><br><br><br>
            <h4>We need your help to preserve the College of Wizardry and run the cancelled 2019 events!</h4>
            <br><br>
            <p class="price"> Rs 76,96,336</p>
...
<p>College of Wizardry, the longest running and largest Magic School immersive event in the world, saw its former organizers cancel all events on March 5. Together with the community from all over the World, International Emmy Award Winning studio The company P has taken over the rights and ownership. Determined to Save College of Wizardry, P is rehiring the international crew, running the events and re-opening the doors for more magic! ⇢ Mobile users click Read The Story below for more details!.</p><br> 
<img src="./img/cul31.png"><br><br>
      
<p>Photo credits at the end of this page–you have our eternal gratitude,<br>
together with all who contributes to make this possible<br>
 

College of Wizardry, the longest running and largest Magic School immersive event in the world, saw its former organizers cancel all events on March 5. Together with the community from all over the World, International Emmy Award Winning studio The company P has taken over the rights and ownership. Determined to Save College of Wizardry, P is rehiring the international crew, running the events and re-opening the doors for more magic!</p><br><br>
        <p><b>WE ARE OVER 110% FUNDED<br>
THREE STRETCH GOALS UNLOCKED!</b></p>
       <img src="./img/cul32.jpg"><br><br>
        <p><b>What our situation?</b> Earlier this year all future events were cancelled, as the former organisers halted operations and let staff go. Despite being sold out, and despite all efforts to continue, they were overextended on too many productions, with insufficient funds to run these larps and other events, and no money for immediate refunds. College of Wizardry has been a labour of love and this is truly heartbreaking for so many.<br>

<b>What are we trying to do?</b> The plan is pretty straight forward. The company P is making a down payment on the castle and risking the investment to produce the events. If we can raise the minimum funds for the events this Spring, we will open the doors again for anyone to go to magic school. We are determined to Save College of Wizardry and hope the magic will prevail!</p>
<br>
        <img src="./img/cul33.png"><br><br>
        <h5><b>P collaborates with USC Games and Avalon Larp Studio to explore playable source material.</b></h5><br>
        <p>The best way to enjoy a poetry slam is to participate live, so feel free to go on our site and find all the details about the events, we'll be happy to hug you!<br></p>
 <img src="./img/cul34.png"><br><br>
             <img src="./img/cul35.PNG"><br><br>
<h1>Magic starts with people!</h1><br>
        
        <h3><b>For all non-magic graduates out there</b></h3>
 <p> of Wizardry is a magical story universe, where the participants populate the world in real, live events. At its core, a beloved live action role-playing series (so called "larps", think cosplay with make-believe) about a magic school that has run 20 main events so far at Czocha castle in Poland.
<br>
We make costumes, wands and mystical artefacts, write stories and create characters–and generally behave as if we can do magic. Of course it's all really an excuse to be humans together (or non-humans)!
         ...
         <img src="./img/cul37.PNG"><br><br>
        

<b>Thank you so much for your attention and slam on!</b>
  </center><br><br>
</p></div>
