...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/cul63.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/cul64.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/cul65.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Ruckus Retreat 2019 - STRETCH GOAL</h1><br><br><br>
            <h4>Interactive and community-based creative retreat in the heart of the countryside</h4>
            <br><br>
            <p class="price"> Rs 4,72,858</p>
    ...
    <hr width="2px">
   <center>
       <img src="./img/cul66.png"><br>
         <img src="./img/cul67.jpg"><br>
        
         <img src="./img/cul68.PNG"><br>
         <img src="./img/cul69.PNG"><br>
         <img src="./img/cul70.PNG"><br>
    
       <img src="./img/cul71.jpg"><br>
 <img src="./img/cul72.png"><br>
       <img src="./img/cul73.jpg"><br>
       <img src="./img/cul74.png"><br> 
