...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/d37.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/d38.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/d39.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>LOTUSWEI FLOWERLOUNGE</h1><br><br><br>
            <h4>Join LOTUSWEI in creating a new wellness hub + flower elixir apothecary.</h4>
            <br><br>
            <p class="price"> Rs 24,99,531 </p>
           
            <div style="border-radius: 20px; width: 20%;"><button type="button" class="btn btn-default cart"><a href="perks.php">Add funds</button></div>
    ...
    <hr width="2px">
   <center>
       <img src="./img/d40.PNG"><br>
        <img src="./img/d41.PNG"><br>
       
        <img src="./img/d42.PNG"><br>
       
        <img src="./img/d42.PNG"><br>
       
        <img src="./img/d43.PNG"><br>
       
        <img src="./img/d44.PNG"><br>
       
        <img src="./img/d45.PNG"><br>
       
        <img src="./img/d46.PNG"><br>
       
        <img src="./img/d47.PNG"><br>
       
        <img src="./img/d48.PNG"><br>
       
        <img src="./img/d49.PNG"><br>
        <img src="./img/d50.PNG"><br>
        <img src="./img/d51.PNG"><br>
