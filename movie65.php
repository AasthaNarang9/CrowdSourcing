  ...
  <div>
      <div class="slideshow-container " style="z-index: -1000;">
        ...
        <div class="mySlides w3-animate-right">
          ...
          <img src=".\img\movie3.jpg" style="width:100%">
          <div class="text">
          </div>
        </div>
      </div>
    ...
    <div style="display: flex; justify-content: space-around;">
      ...
      <div style="display: flex; justify-content: space-around; border-radius: 10px; padding-bottom: 30px; ">
         ...
         <div class="card" style="width: 30%; padding-bottom: 30px;">
            <img src=".\img\dom1.jpg"style="width:100% ">
            <h2>Dornalai Cailin : Girl Boxer Pilot Project</h2>
            <p class="price">Rs. 19,811,484</p>
            <p>A hard-up-single-mother and former boxer, is lured by the Irish mob into an underground boxing match
            </p><br><br>
            <form action="moviep1.html">
                <button type="submit"><a href="moviep1.html">VIEW DETAILS</a></button>
            </form>
        </div>
            <div class="card" style="width: 30%;padding-bottom: 30px;" >
            <img src=".\img\mul1.png" style="width:100%">
            <h2>Multiplex 10: The Web Series Finishing Funds</h2>
            <p class="price">Rs. 10,811,484</p>
            <p>Help fund the FINAL EPISODES of Multiplex 10: The Web Series!</p><br><br><br>
            <form action="moviep4.html">
            <button type="submit"><a href="moviep4.html">VIEW DETAILS</a></button>
            </form>
          </div>


        <div class="card" style=" width: 30%; padding-bottom: 30px;" >
            <img src=".\img\har3.jpg" style="width:100%">
            <h2>HARGRAVE</h2>
            <p class="price">Rs. 12,811,484</p>
            <p>In the darkness you will find, that which your soul already knows.</p><br><br><br><br><br>
            <form action="moviep3.html">
             <button type="submit"><a href="moviep3.html">VIEW DETAILS</a></button>
            </form>
        </div>
    </div>
    ...
    <div style="display: flex; justify-content: space-around; border-radius: 10px;">
        <div class="card" style="width: 30%; padding-bottom: 30px;" >
          <img src=".\img\exo1.jpg"style="width:100%">
          <h2>Exotic Blaque</h2>
          <p class="price">Rs. 34,841,484</p>
          <p>She is just like you, but black!</p><br><br><br>
         <form action="moviep4.html">
           <button type="submit"><a href="moviep4.html">VIEW DETAILS</a></button>
          </form>
        </div>
           ...
           <div class="card" style="width: 30%; padding-bottom: 30px;" >
  <img src=".\img\sc1.jpg"style="width:100%">
  <h2>Science With Sophie</h2>
  <p class="price">4,841,484</p>
  <p>Bigger, Smarter, Braver, Sillier, and Science-ier than ever.</p><br>
 <form action="moviep5.html">
 <button type="submit"><a href="moviep5.html">VIEW DETAILS</a></button>
    </form>
</div>

           <div class="card" style="width: 30%; padding-bottom: 30px;" >
  <img src=".\img\ruck1.jpg"style="width:100%">
  <h2>A Good Ruckus - Pilot Episode </h2>
  <p class="price">Rs. 4,841,484</p>
  <p>You can sit around, bored. Or you can create a ruckus.</p><br><br>
 <form action="moviep6.html">
<button type="submit"><a href="moviep6.html">VIEW DETAILS</a></button>
    </form>
</div>
</div>
