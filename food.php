...
<body>
  <div>
      ...
      <div style="display: flex; justify-content: space-around; border-radius: 10px; padding-bottom: 30px; ">
         ...
         <div class="card" style="width: 30%; padding-bottom: 30px;">
           <img src=".\img\food1.jpeg"style="width:100% ">
            <h2>Niche Zero: The best conical burr coffee grinder.</h2>
           <p class="price">₹19,811,484</p>
            <p>The only way to become a true home barista and make the best tasting coffee, every time.</p><br>
            <form action="food1.html">
                <button type="submit"><a href="food1.html">VIEW DETAILS</a></button>
            </form>
        </div>
            <div class="card" style="width: 30%;padding-bottom: 30px;" >
            <img src=".\img\food2.jpeg" style="width:100%">
            <h2>The Spirit Top - The Modern Day Mini Bottle</h2>
            <p class="price">₹10,811,484</p>
            <p>An Aluminum Container Offering Users the Choice: 1. Open and Pour 2. Create a Self-Contained Drink!</p>
            <form action="food2.html">
        ...
        <div class="card" style="width: 30%; padding-bottom: 30px;" >
          <img src=".\img\foo.jpg" style="width:100%">
            <h2>Albicchiere: Smart Wine Preservation </h2>
            <p class="price">₹12,811,484</p>
            <p>Enjoy the perfect glass of wine at the perfect temperature up to 6 months from the opening date.</p><br><br>
            <form action="food3.html">
              <button type="submit">VIEW DETAILS</button>
            </form>
        </div>
    </div>
    ...
    <div style="display: flex; justify-content: space-around; border-radius: 10px;">
        <div class="card" style="width: 30%; padding-bottom: 30px;" >
          <img src=".\img\food4.jpeg"style="width:100%">
          <h2>COFFEEJACK - The Pocket-Sized Barista</h2>
          <p class="price">34,841,484</p>
          <p>Pollution Saving Espresso Maker No Bigger than a Cup</p>
         <form action="food4.html">
           <button type="submit">VIEW DETAILS</button>
          </form>
        </div>

           <div class="card" style="width: 29%; padding-bottom: 30px;" >
  <img src=".\img\food8.jpeg"style="width:100%">
  <h2>Juno - Like a Microwave for Cooling</h2>
  <p class="price">4,841,484</p>
  <p>Rapidly chill wine, beer, coffee and more in under 1 minute!</p><br>
 <form action="food5.html">
 <button type="submit">VIEW DETAILS</button>
    </form>
</div>

           <div class="card" style="width: 30%; padding-bottom: 30px;" >
  <img src=".\img\food6.jpeg"style="width:100%">
  <h2>The Billionaire Suit- Made Affordable  </h2>
  <p class="price">4,841,484</p>
  <p>BWe figured out a way to HACK the Fashion Industry by eliminating the Middlemen and slashed the cost!<br><br>
 <form action="food6.html">
 <button type="submit">VIEW DETAILS</button>
    </form>
</div>
</div>
