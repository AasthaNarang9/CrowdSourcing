    ...
    <div>
      <div class="slideshow-container " style="z-index: -1000;">
        <div class="mySlides w3-animate-right">
          ...
          <img src=".\img\art11.jpg" style="width:100%">
        </div>
        <div class="mySlides w3-animate-right">
          <div class="numbertext">2 / 3</div>
          <img src=".\img\art12.jpg" style="width:100%">
        </div>
        <div class="mySlides w3-animate-right">
          <div class="numbertext">3 / 3</div>
          <img src=".\img\art13.jpg" style="width:100%">
          <div class="text">
        ...
        <div style="background-color:# bbb; width: 100%;padding: 0;">
          <center>
            ...
            <ul id="myMenu" style="background-color: transparent; padding-left: 0px;">
              ...
              <li class="Menuclass" style="padding-top: 5px; padding-bottom: 5px;"><a style="padding: 0;" href="a1.html">
                  <h4>Art</h4>
                </a></li>
      ...
      <div style="display: flex; justify-content: space-around; border-radius: 10px; padding-bottom: 30px; width: 100%">
         ...
         <div class="card" style="width: 30%; padding-bottom: 30px;">
            ...
            <form action="pr1.html">
                <button type="submit"><a href="artp.html" style="text-decoration: none;color: black;">VIEW DETAILS</a></button>
            </form>
        </div>
            <div class="card" style="width: 30%;padding-bottom: 30px;" >
            <img src=".\img\artcap4.jpg" style="width:100%">
            <h2>Art Capsules</h2>
            <p class="price">RS 10,811,484</p>
            <p>Art Capsules offers exclusive and carefully curated contemporary art at an affordable price</p><br><br><br>
            <form action="p2.html">
              <button type="submit"><a href="artp2.html" style="text-decoration: none;color: black;">VIEW DETAILS</a></button>
            </form>
          </div>


        <div class="card" style="width: 30%; padding-bottom: 30px;" >
            <img src=".\img\artt1.jpg" style="width:100%">
            <h2>Candles By Travis</h2>
            <p class="price"> RS 12,81,484</p>
            <p>Help get my candle company, lit! Cheated, stolen from, and humiliated. </p><br><br>
            <form action="p3.html">
              <button type="submit"><a href="artp3.html" style="text-decoration: none;color: black;">VIEW DETAILS</a></button>
            </form>
        </div>
    </div>

    <div style="display: flex; justify-content: space-around; border-radius: 10px; width: 100%;">
        <div class="card" style="width: 30%; padding-bottom: 20px;" >
          <img src=".\img\artt14.jpg"style="width:100%">
          <h2>Tarot Of Saqqara</h2>
          <p class="price">RS 34,41,484</p>
          <p>Tarot of Saqqara has lifetimes of information embedded in each card with impressive intuitive symbology.  </p>
         <form action="p3.html">
            <button type="submit"><a href="artp4.html" style="text-decoration: none;color: black;">VIEW DETAILS</a></button>
          </form>
        </div>

           <div class="card" style="width: 29%; padding-bottom: 20px;" >
  <img src=".\img\artt15.jpg"style="width:100%">
  <h2>Remedial Sketches </h2>
  <p class="price">RS 4,84,484</p>
  <p>Lewis Rossignol's newest book; a collection of the most compelling pages from his sketchbooks.</p><br>
 <form action="p3.html">
 <button type="submit"><a href="artp5.html" style="text-decoration: none;color: black;">VIEW DETAILS</a></button>
    </form>
</div>

           <div class="card" style="width: 30%; padding-bottom: 20px;" >
  <img src=".\img\art20.jpg"style="width:100%">
  <h2>Hot Steel sculpture </h2>
  <p class="price">RS 4,01,484</p>
  <p>80's inspired Sci-Fi wall art.80's inspired Sci-Fi wall art. </p><br>
 <form action="p3.html">
 <button type="submit"><a href="artp6.html" style="text-decoration: none;color: black;">VIEW DETAILS</a></button>
    </form>
</div>
</div>
