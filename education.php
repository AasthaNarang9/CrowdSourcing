...
<body>
  <div>
    ...
    <div>
      <div class="slideshow-container " style="z-index: -1000; width: 100%;">
        <div class="mySlides w3-animate-right">
          ...
          <img src="./img/rsz_1ed.jpg" style="width:100%;" height="100%;">
        </div>
        <div class="mySlides w3-animate-right">
          <div class="numbertext">2 / 3</div>
          <img src="./img/timthumb.jpg" style="width:100%; height: 100%;">
        </div>
        <div class="mySlides w3-animate-right">
          <div class="numbertext">3 / 3</div>
          <img src="./img/hero-education-landing.image.large_2x.jpg" style="width:100%; height: 100%;">
    ...
    <div style="display: flex; justify-content: space-around;">
      ...
      <div style="display: flex; justify-content: space-around; border-radius: 10px; padding-bottom: 30px; ">
         ...
         <div class="card" style="width: 30%; padding-bottom: 30px;">
           <img src=".\img\e1.jpeg"style="width:100% ">
            <h2>Basic Robotics In Construction Kit by Geeek Club</h2>
           <p class="price">₹19,811,484</p>
            <p>Have fun while learning hardware and electrical engineering skills and building robots with coding</p>
            <form action="education1.html">
                <button type="submit"><a href="education1.html">VIEW DETAILS</a></button>
            </form>
        </div>
            <div class="card" style="width: 30%;padding-bottom: 30px;" >
            <img src=".\img\e2.jpeg" style="width:100%">
            <h2>Lily: The 1st smart speaker teaches Chinese</h2>
            <p class="price">₹10,811,484</p>
            <p>Learn Chinese the natural way. No books, no vocabulary lists, no flash cards. Just speak chinese.</p>
            <form action="education2.html">
        ...
        <div class="card" style="width: 30%; padding-bottom: 30px;" >
          <img src=".\img\lens1.jpg" style="width:100%">
            <h2>ShiftCam Multi-Lens Case for the iPhone 11 Series</h2>
            <p class="price">₹12,811,484</p>
            <p>Change between lenses in less than a second. Best Rated iPhone Lens Quality by Tom�s Guide.</p><br>
            <form action="education3.html">
              <button type="submit">VIEW DETAILS</button>
            </form>
        </div>
    </div>
    ...
    <div style="display: flex; justify-content: space-around; border-radius: 10px;">
        <div class="card" style="width: 30%; padding-bottom: 30px;" >
          <img src=".\img\cat1.jpeg"style="width:100%">
          <h2>Nybble - World's Cutest Kitten</h2>
          <p class="price">34,841,484</p>
          <p>Nybble makes programming and robotics fun to learn and understand, all in one cute package!.</p>
         <form action="education4.html">
           <button type="submit">VIEW DETAILS</button>
          </form>
        </div>

           <div class="card" style="width: 29%; padding-bottom: 30px;" >
  <img src=".\img\bib11.png"style="width:100%">
  <h2>Instrument Bible: Learn Instrument</h2>
  <p class="price">4,841,484</p>
  <p>A virtual fingering chart for brass, woodwind, and string instruments.</p><br>
 <form action="education5.html">
 <button type="submit">VIEW DETAILS</button>
    </form>
</div>

           <div class="card" style="width: 30%; padding-bottom: 30px;" >
  <img src=".\img\act.jpg"style="width:100%">
  <h2>MarsCat: A Bionic Cat, a Home Robot </h2>
  <p class="price">4,841,484</p>
