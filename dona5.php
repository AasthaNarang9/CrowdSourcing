...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/d65.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/d66.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/d67.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Help Us Legalize Medical Marijuana in Texas!</h1><br><br><br>
            <h4>Texans deserve safe and legal access to medical marijuana. Let's make it a reality -- Donate Today!</h4>
            <br><br>
    ...
    <hr width="2px">
   <center>
       <img src="./img/d68.PNG"><br>
     
         <img src="./img/d69.jpg"><br>
         <img src="./img/d70.PNG"><br>
    
       <img src="./img/d71.jpg"><br>
       <img src="./img/d72.png"><br>

     
       <img src="./img/d73.jpg"><br>
       <img src="./img/d74.png"><br>
