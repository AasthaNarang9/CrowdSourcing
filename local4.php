...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/lb43.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/lb44.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/lb45.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Uppliva Sauna & Steam</h1><br><br><br>
            <h4>Help us build a unique & uplifting spa experience in the heart of Hintonburg, Ottawa!</h4>
            <br><br>
            <p class="price"> Rs 15,02,313 I</p>
    ...
    <hr width="2px">
   <center>
       <img src="./img/lb46.PNG"><br>
         <img src="./img/lb47.PNG"><br>
        
         <img src="./img/lb48.PNG"><br>
         <img src="./img/lb49.PNG"><br>
    
       <img src="./img/lb50.PNG"><br>
       
       <img src="./img/lb51.PNG"><br>
  <img src="./img/lb52.PNG"><br>
        <img src="./img/lb53.PNG"><br>
