...
<center>
    <div style="display: flex; justify-content: space-around; width: 80%;" >
        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/hr36.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/hr37.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./img/hr38.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
      ...
      <div> <br><br><br>
            <h1>Support Kindness Cafe in Charlottesville</h1><br><br><br>
            <h4>Kindness Cafe employs adults with cognitive disabilities. It'll be the most welcoming cafe in town!g</h4>
            <br><br>
            <p class="price"> Rs 19,45,796</p>
    ...
    <hr width="2px">
   <center>
       <img src="./img/hr39.PNG"><br>
         <img src="./img/hr40.png"><br>
        
         <img src="./img/hr41.png"><br>
         <img src="./img/hr42.png"><br>
    
       <img src="./img/hr43.png"><br>
 
       <img src="./img/hr44.png"><br>
